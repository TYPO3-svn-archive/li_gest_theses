...
$TCA["tx_ligesttheses_Cotutelle"] = array (
	"ctrl" => array (
		...
		'label'     => 'NomCotutelle, PrenomCotutelle',
		'label_alt' => 'NomCotutelle, PrenomCotutelle',	
		'label_alt_force' => '1',
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
...
// allow TheseHDR records on normal pages
t3lib_extMgm::allowTableOnStandardPages('tx_ligesttheses_Financement');
// add the TheseHDR record to the insert records content element
t3lib_extMgm::addToInsertRecords('tx_ligesttheses_Financement');

$TCA["tx_ligesttheses_Financement"] = array (
	"ctrl" => array (
		'title'     => 'LLL:EXT:li_gest_theses/locallang_db.xml:tx_ligesttheses_Financement',	
		'label'     => 'Libelle',
		'label_alt' => '',
		'label_alt_force' => '1',
		'tstamp'    => 'tstamp',
		...
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_ligesttheses_Financement.gif',
	),
	"feInterface" => array (
