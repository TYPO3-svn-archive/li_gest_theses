	...
	function main($content,$conf)	{
		...
		while($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res))       {
			...
			//**************************************
				...
				$Cotutelle_limit = "";
				$Cotutelle_tryMemcached = "";

				$Cotutelle_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($Cotutelle_select_fields, $Cotutelle_from_table, $Cotutelle_where_clause, $Cotutelle_groupBy, $Cotutelle_orderBy, $Cotutelle_tryMemcached);
